...
public class ListaPesquisa extends javax.swing.JFrame {
    ...
    PesquisaTableModel tableModel = new PesquisaTableModel();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String j = i.toString();
        this.dispose();	
        PesquisaEleitoral p =new PesquisaEleitoral(j);
        p.setDefaultCloseOperation(Inicio.DISPOSE_ON_CLOSE);
        p.setVisible(true);
        
    }
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        this.dispose();
        PesquisaEleitoral cadastro = new PesquisaEleitoral("0");

        cadastro.setDefaultCloseOperation(Inicio.DISPOSE_ON_CLOSE);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        new PesquisaStorage().deleteList((String)i);
